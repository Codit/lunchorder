...
namespace Lunchorder.Domain.Constants
{
    ...
    public static class Badges
    {
        ...
        public static readonly Badge BadgeCollector = new Badge(Guid.Parse("75d335ab-18db-440e-ae7d-f3f6615dd9ab"), "Badge Collector", false, "Collect a total of 10 badges", "collector_10_200x200.png", "collector_10_800x800.png");
        public static readonly Badge HighRoller = new Badge(Guid.Parse("e1d4752b-1a85-48ae-bb61-8532e1e58926"), "High Roller", true, "Spend €30 euros in one week", "high_roller_200x200.png", "high_roller_800x800.png");
        public static readonly Badge DeepPockets = new Badge(Guid.Parse("b8f30097-3d08-4ade-8b89-478d6b48e540"), "Deep Pockets", true, "Spend €75 euros in one month", "deep_pockets_200x200.png", "deep_pockets_800x800.png");
        ...
        public static readonly Badge CloseCall30 = new Badge(Guid.Parse("63150f8b-aa56-4555-9539-d4311745f1a9"), "Close Call 30", true, "Make an order between 15 and 30 seconds before the final order time", "close_call_30sec_200x200.png", "close_call_30sec_800x800.png");
        public static readonly Badge CloseCall45 = new Badge(Guid.Parse("9fe7a8f4-fae1-4508-a9ae-c085c6a16863"), "Close Call 45", true, "Make an order between 30 and 45 seconds before the final order time", "close_call_45sec_200x200.png", "close_call_45sec_800x800.png");
        public static readonly Badge CloseCall60 = new Badge(Guid.Parse("555e21c8-e7f5-4455-af27-9bd11f6eced9"), "Close Call 60", true, "Make an order between 45 and 60 seconds before the final order time", "close_call_60sec_200x200.png", "close_call_60sec_800x800.png");
        ...
        public static readonly Badge Healthy = new Badge(Guid.Parse("0e094fa6-14ed-4fed-86a5-49f52bebcafb"), "Healthy", true, "Make 3 healthy orders in the same week", "healthy_200x200.png", "healthy_800x800.png");
        public static readonly Badge PastaAddict = new Badge(Guid.Parse("3e41f5bd-3c8c-42e5-ad1c-687a96a6f4e8"), "Pasta Addict", true, "Order 52 pasta's in a year", "pastaddict_200x200.png", "pastaddict_800x800.png");
        ...
        {
            HaveFaith, BadgeCollector, HighRoller, DeepPockets, Consumer, Enjoyer, DieHard, Bankrupt, CloseCall15, CloseCall30, CloseCall45, CloseCall60, DoubleOrder, FirstOrder, Healthy, //Mobile
        };
    }
}